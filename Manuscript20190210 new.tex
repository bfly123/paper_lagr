...
\begin{figure}[htp]
  ...
  \begin{tikzpicture}
    ...
    %\draw  (0,0) -- ([turn]135:3.5) node [above]{ight elastic/plastic};
    \draw  (0,0) -- ([turn]-155:3.5) node [above]{Elastic2} ;
	\draw[dashed]  (0,0) -- ([turn]-125:3.5) node [above]{Plastic2} ;
    \draw  (0,0) -- ([turn]-105:3.5) node [above]{Elastic 1/Plastic1} ;
...
\begin{figure}[htp]
  ...
  \begin{tikzpicture}
    ...
    \draw [double](0,0) -- ([turn]165:3.5)   node [above]{Contact};
    %\draw  (0,0) -- ([turn]135:3.5) node [above]{ight elastic/plastic};
    \draw  (0,0) -- ([turn]-145:3.5) node [above]{Elastic2} ;
	\draw[dashed]  (0,0) -- ([turn]-160:3.5) node [above]{Plastic2} ;
    \draw  (0,0) -- ([turn]-105:3.5) node [above]{Elastic1} ;
	\draw[dashed] (0,0) -- ([turn]-115:3.5) node [above]{Plastic1} ;
%    \node at (-1.3,0.5) {$\mathbf{Q}_L$};
%    \node at (-0.6,1.2) {$\mathbf{Q}_L^*$};p
%    \node at (0.7,1.2) {$\mathbf{Q}_R^*$};
%    \node at (1.3,0.5) {$\mathbf{Q}_R$};
...
\begin{figure}[htp]
  ...
  \begin{tikzpicture}
    ...
    \draw  (0,0) -- ([turn]-145:3.5) node [above]{Elastic2} ;
	\draw[dashed]  (0,0) -- ([turn]-160:3.5) node [above]{Plastic2} ;
	\draw  (0,0) -- ([turn]-105:3.5) node [above]{Elastic1/Plastic1} ;
%	\draw[dashed] (0,0) -- ([turn]-115:3.5) node [above]{Plastic1} ;
%    \node at (-1.3,0.5) {$\mathbf{Q}_L$};
%    \node at (-0.6,1.2) {$\mathbf{Q}_L^*$};p
%    \node at (0.7,1.2) {$\mathbf{Q}_R^*$};
...
\begin{figure}[htp]
  ...
  \begin{tikzpicture}
    ...
    \draw [double](0,0) -- ([turn]165:3.5)   node [above]{Contact};
    %\draw  (0,0) -- ([turn]135:3.5) node [above]{ight elastic/plastic};
    \draw  (0,0) -- ([turn]-155:3.5) node [above]{Elastic2/Plastic2} ;
    \draw  (0,0) -- ([turn]-105:3.5) node [above]{Elastic1/Plastic1} ;
%    \node at (-1.3,0.5) {$\mathbf{Q}_L$};
%    \node at (-0.6,1.2) {$\mathbf{Q}_L^*$};p
%    \node at (0.7,1.2) {$\mathbf{Q}_R^*$};
